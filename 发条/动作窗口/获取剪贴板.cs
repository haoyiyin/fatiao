...
{
    public partial class 获取剪贴板 : Form
    {
        public 获取剪贴板()
        {
            InitializeComponent();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            发条.发条窗口.listBox1.Items.Insert(选中行, "获取剪贴板(" + textBox4.Text  + ");" + textBox3.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox4.Text != "")
            {
                ...
                {
                    发条.发条窗口.listBox1.Items.Insert(发条.发条窗口.listBox1.SelectedIndex + 1, "获取剪贴板(" + textBox4.Text + ");" + textBox3.Text);
                    if (textBox2.Text != "")
                    {
                ...
                {
                    发条.发条窗口.listBox1.Items.Add("获取剪贴板(" + textBox4.Text + ");" + textBox3.Text);
                    if (textBox2.Text != "")
                    {
        ...
        private void 获取剪贴板_FormClosing(object sender, FormClosingEventArgs e)
        {
