...
namespace fatiao
{
    public class 快捷命令
    {
        ...
        public static bool 停止作用 = false;//用作停止线程
        ...
        public  void 快捷命令运行()
        {
            try
            {
                ...
                object 坐标一;//找图找色返回坐标
                object 坐标二;//找图找色返回坐标
                int 最大行 = 发条.发条窗口.listBox6.Items.Count;//最大行数下限
                ...
                while (当前行 < 最大行)//运行行数小于最大行数时
                {
                    ...
                    每行内容 = 发条.发条窗口.listBox6.Items[当前行].ToString();//读取运行行内容
                    //发条.发条窗口.listBox6.SelectedIndex = -1;//取消前一个高亮
                    //发条.发条窗口.listBox6.SelectedIndex = 当前行;//高亮当前运行行
                    当前行++;//运行行数递增+1
                    ...
                    switch (动作类[0])
                    {
                        case "点击图片":
                            ...
                            ThreadPool.UnsafeQueueUserWorkItem(new WaitCallback((object s) =>
                            {
                                ...
                                if (图色 != -1)
                                {
                                    发条.发条窗口.fatiao.MoveTo((int)坐标一, (int)坐标二);
                        ...
                        case "首次请求输入":
                            ...
                            发条.发条窗口.listBox6.Items.Insert(当前行, "变量赋值(" + 参数[0] + "=\"" + 发条.发条窗口.快捷命令输入变量值 + "\");");

                            发条.发条窗口.listBox6.Items.RemoveAt(当前行 - 1);//删除当前行
                        ...
                        case "随机数字":
                            if (参数[0] != "")//变量未空
                            {
                                ...
                                {
                                    起始值 = int.Parse(动作.变量读取ini("变量名", 参数[1], "-1", @".\Generate\subvariable.ini"));
                                    最大值 = int.Parse(参数[2]);
                                }
                                else if (发条.发条窗口.判断数字(参数[1]) == "整数" && 发条.发条窗口.判断数字(参数[2]) != "整数")
                                {
                                    起始值 = int.Parse(参数[1]);
                                    最大值 = int.Parse(动作.变量读取ini("变量名", 参数[2], "-1", @".\Generate\subvariable.ini"));
                                }
                                else//两个都不是
                                {
                                    起始值 = int.Parse(动作.变量读取ini("变量名", 参数[1], "-1", @".\Generate\subvariable.ini"));
                        ...
                        case "等待时间":
                            ...
                            {
                                返回变量 = 动作.变量读取ini("变量名", 参数六, "-1", @".\Generate\subvariable.ini");

                                for (int 循环 = 0; 循环 < int.Parse(返回变量) / 15; 循环++)
                                {
                                    Delay(1);
                                    if (停止作用 == true)//停止循环的开关
                                    {
                        ...
                        case "鼠标操作":
                            try
                            {
                                ...
                                {
                                    坐标x1 = int.Parse(动作.变量读取ini("变量名", 参数[2], "-1", @".\Generate\subvariable.ini"));
                                }
                                ...
                                {
                                    坐标y1 = int.Parse(动作.变量读取ini("变量名", 参数[3], "-1", @".\Generate\subvariable.ini"));
                                }
                                if (参数[0] == "随机移动" || 参数[0] == "轨迹移动")
                                {
                                    ...
                                    {
                                        坐标x2 = int.Parse(动作.变量读取ini("变量名", 参数[4], "-1", @".\Generate\subvariable.ini"));
                                    }
                                    ...
                                    {
                                        坐标y2 = int.Parse(动作.变量读取ini("变量名", 参数[5], "-1", @".\Generate\subvariable.ini"));
                                    }
                                }
                            }
                        ...
                        case "按键操作":
                            ...
                            else
                            {
                                ...
                                {
                                    int 整数变量值 = int.Parse(动作.变量读取ini("变量名", 参数[1], "-1", @".\Generate\subvariable.ini"));
                                    switch (参数[0])
                                    {
                                        case "点击":
                        ...
                        case "判断颜色":
                            ...
                            {
                                坐标x1 = int.Parse(动作.变量读取ini("变量名", 参数[1], "-1", @".\Generate\subvariable.ini"));
                            }
                            if (发条.发条窗口.判断数字(参数[2]) == "整数")
                            {
                                坐标y1 = int.Parse(参数[2]);
                            ...
                            {
                                坐标y1 = int.Parse(动作.变量读取ini("变量名", 参数[2], "-1", @".\Generate\subvariable.ini"));
                            }
                        ...
                        case "查找颜色":
                            try
                            {
                                ...
                                {
                                    坐标x1 = int.Parse(动作.变量读取ini("变量名", 参数四[0], "-1", @".\Generate\subvariable.ini"));
                                }
                                ...
                                {
                                    坐标y1 = int.Parse(动作.变量读取ini("变量名", 参数四[1], "-1", @".\Generate\subvariable.ini"));
                                }
                                ...
                                {
                                    坐标x2 = int.Parse(动作.变量读取ini("变量名", 参数四[2], "-1", @".\Generate\subvariable.ini"));
                                }
                                ...
                                {
                                    坐标y2 = int.Parse(动作.变量读取ini("变量名", 参数四[3], "-1", @".\Generate\subvariable.ini"));
                                }
                            }
                            catch
                            {
                                ...
                                {
                                    坐标x1 = int.Parse(动作.变量读取ini("变量名", 参数[4], "-1", @".\Generate\subvariable.ini"));
                                }
                                if (发条.发条窗口.判断数字(参数[5]) == "整数")
                                {
                                    坐标y1 = int.Parse(参数[5]);
                                ...
                                {
                                    坐标y1 = int.Parse(动作.变量读取ini("变量名", 参数[5], "-1", @".\Generate\subvariable.ini"));
                                }
                                ...
                                {
                                    坐标x2 = int.Parse(动作.变量读取ini("变量名", 参数[6], "-1", @".\Generate\subvariable.ini"));
                                }
                                ...
                                {
                                    坐标y2 = int.Parse(动作.变量读取ini("变量名", 参数[7], "-1", @".\Generate\subvariable.ini"));
                                }
                            }
                        ...
                        case "判断画面":
                            ...
                            {
                                坐标y2 = int.Parse(动作.变量读取ini("变量名", 参数[4], "-1", @".\Generate\subvariable.ini"));
                            }
                        ...
                        case "﹁如果始":
                            if (参数一.Contains("不等于")) //是否包含“不等于”符号
                            {
                                ...
                                {
                                    返回变量 = 动作.变量读取ini("变量名", 参数三[0], "空", @".\Generate\subvariable.ini");
                                }
                                ...
                                {
                                    返回变量二 = 动作.变量读取ini("变量名", 参数三[1], "空", @".\Generate\subvariable.ini");
                                }
                        ...
                        case "整数运算":
                            if (参数一.Contains("-=") == true) //是否包含-=复合运算符号
                            {
                                ...
                                参数六 = 动作.变量读取ini("变量名", 参数四[0], "空", @".\Generate\subvariable.ini");
                        ...
                        case "运行命令":
                            发条.发条窗口.notifyIcon1.ShowBalloonTip(1000, "发条错误", "暂不可嵌套命令，开发中……", ToolTipIcon.Error);
                            发条.发条窗口.停止快捷命令();
                            break;
                    }
                    #endregion
                }
                if (发条.发条窗口.toolStripMenuItem5.Text == "停止命令")
                {
                    发条.发条窗口.toolStripMenuItem5.Text = "运行命令";
                    发条.发条窗口.toolStripMenuItem5.Image = Properties.Resources.运行;
                    停止作用 = false;
                    发条.发条窗口.动作行快捷键 = true;
                }
            }
            ...
            {
                Console.WriteLine(ex);
                发条.发条窗口.notifyIcon1.ShowBalloonTip(1000, "发条错误", "当前命令参数不完整或不正确，请尝试重新编辑后运行", ToolTipIcon.Error);
                发条.发条窗口.停止快捷命令();
                return;
            }
            ...
            {
                动作.变量写入ini("变量名", 变量名, 变量值, @".\Generate\subvariable.ini");
            }

            string 引用变量(string 变量名)
            {
                return 动作.变量读取ini("变量名", 变量名, "空", @".\Generate\subvariable.ini");
            }
